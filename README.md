...
## Confira também o vídeo de apresentação da API .NET e testes no YouTube:
...
https://youtu.be/9X3xrN_2FdU?feature=shared

`Vídeo de Apresentação Geral do Projeto` 

https://youtu.be/YdZeIElCnHE?feature=shared
